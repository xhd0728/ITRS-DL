...
from transformers import AutoProcessor, ChineseCLIPModel, ChineseCLIPTextModel, ChineseCLIPVisionModel, CLIPTextModelWithProjection
...
if __name__ == '__main__':
    ...
    image_encoder = ChineseCLIPVisionModel.from_pretrained(
        checkpoint_dir,
    ...
    with torch.no_grad():
        for step, batch in enumerate(tqdm(dataloader)):
            ...
            if inputs['pixel_values'].shape[0] != inputs['input_ids'].shape[0]:
                ...
                text_embeds = text_features.squeeze().cpu().numpy()
